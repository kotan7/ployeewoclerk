...
export default function Home() {
  ...
  useEffect(() => {
    ...
    gsap.set([heroBoxRef.current, heroTitleRef.current, heroSubtitleRef.current, heroButtonsRef.current], {
      opacity: 0,
      y: 30
    });
    
    // Staggered animation sequence for hero
    heroTl.to(heroBoxRef.current, {
      opacity: 1,
      y: 0,
      duration: 0.8,
      ease: "power2.out"
    ...
    if (problemSectionRef.current && problemTextRef.current && problemImageRef.current) {
      // Set initial states
      ...
      problemTl.to(problemTextRef.current, {
        opacity: 1,
        y: 0,
        duration: 1,
        ease: "power2.out"
    ...
    if (featuresSectionRef.current && feature1Ref.current && feature2Ref.current && feature3Ref.current) {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white relative">
        ...
        <footer ref={footerRef} className="bg-[#163300] text-white py-12 fixed bottom-0 left-0 right-0 z-0">
            ...
            <div className="relative inline-block mb-15">
              ...
              >
                <div className="px-8 pb-12 mt-28 mb-8">
                  <h1 ref={heroTitleRef} className="text-4xl text-center lg:text-6xl font-bold text-[#163300] mb-6 leading-tight">
                    内定まで、何度でも叩き込む。
                    <br />
                    <span className="text-[#9fe870]">AI面接官</span>
                    、24時間フル稼働。
                  </h1>
                  <p ref={heroSubtitleRef} className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto font-bold text-center">
        ...
        {/* Problem Section */}
        <section ref={problemSectionRef} className="py-20 bg-gray-200/100 backdrop-blur-sm relative z-10">
        ...
        {/* Features Section */}
        <section ref={featuresSectionRef} className="py-20 relative z-10 mt-10 -mb-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="sr-only">AI面接練習サービスの特徴</h2>
            <div className="grid lg:grid-cols-3 gap-8">
              {/* Feature 1 */}
              <article ref={feature1Ref} className="bg-white shadow-sm hover:shadow-lg transition-shadow rounded-2xl border border-gray-100 p-6">
                <div
              ...
              {/* Feature 2 */}
              <article ref={feature2Ref} className="bg-white shadow-sm hover:shadow-lg transition-shadow rounded-2xl border border-gray-100 p-6">
                <div
                  className="w-12 h-12 bg-[#9fe870] rounded-xl flex items-center justify-center mb-6"
                  aria-hidden="true"
                >
              ...
              {/* Feature 3 */}
              <article ref={feature3Ref} className="bg-white shadow-sm hover:shadow-lg transition-shadow rounded-2xl border border-gray-100 p-6">
                <div
                  className="w-12 h-12 bg-[#9fe870] rounded-xl flex items-center justify-center mb-6"
                  aria-hidden="true"
                >
        ...
        <section ref={transformationSectionRef} className="relative z-10 h-screen flex items-center m-0 p-0 mb-0" style={{ marginBottom: 0, paddingBottom: 0 }}>
            ...
            >
              ...
              >
                ...
                <div className="text-center text-[#163300] min-h-screen flex flex-col items-center justify-center">
                  ...
                  <div ref={transformationTextRef} className="text-xl mb-8 leading-relaxed opacity-80">
                    <p ref={line1Ref} className="line-1">
                      {splitTextIntoChars("そんな不安を「準備した」という安心変えていきませんか？")}
                    </p>
                    <p ref={line2Ref} className="line-2">
                      {splitTextIntoChars("就活の不安を「可視化」し、「成長」に変える。")}
                    </p>
                    <p ref={line3Ref} className="line-3">
                      {splitTextIntoChars("あなたの本気に、本気で応えるAI面接サービス。")}
                    </p>
                  </div>
