          ...
          <SignedOut>
            <div className="text-center py-20">
              ...
              <p className="text-gray-600 mb-8 max-w-md mx-auto">
                ...
                を始めるには、まずアカウントにログインしてください
              </p>
              <SignInButton mode="modal">
                <button
                  className="cursor-pointer bg-[#9fe870] text-[#163300] px-8 py-4 rounded-full font-semibold text-lg hover:bg-[#8fd960] transition-colors shadow-lg hover:shadow-xl transform hover:scale-105"
                  aria-label="ログインしてAI面接練習を始める"
                >
                  ログインして面接練習を始める
                </button>
              </SignInButton>
